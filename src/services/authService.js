...
class AuthService {
    constructor() {
        ...
        Object.defineProperty(this, "inactivityTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "sessionCheckInterval", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        });
        Object.defineProperty(this, "lastActivityTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: Date.now()
        ...
        Object.defineProperty(this, "HIGH_SECURITY_ROLES", {
            enumerable: true,
            configurable: true,
            writable: true,
        ...
        Object.defineProperty(this, "INACTIVITY_TIMEOUT", {
            ...
            writable: true,
            value: 2 * 60 * 1000
        }); // 2 minutes maximum inactivity (if no activity)
        Object.defineProperty(this, "SESSION_CHECK_INTERVAL", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 30 * 1000
        }); // Check every 30 seconds for better responsiveness
        Object.defineProperty(this, "SESSION_TIMEOUT", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 24 * 60 * 60 * 1000
        }); // 24 hours maximum session timeout (extended since we track activity)
    }
        ...
        try {
            ...
            try {
                ...
                if (error.requires2FA) {
                    const twoFactorError = new Error('2FA code required');
            ...
            const isHighSecurity = this.HIGH_SECURITY_ROLES.includes(user.role);
    ...
    isAuthenticated() {
        ...
        const mostRecentActivity = Math.max(lastActivity.getTime(), this.lastActivityTime);
